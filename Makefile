...
venv: FORCE
	rm -rf ~/.venv/ungeeks
	python3 -m venv ~/.venv/ungeeks
	echo . ~/.venv/ungeeks/bin/activate > venv
	echo export PATH='$$PATH:$(PWD)/bin' >> venv
	. ./venv && pip3 install PyYAML pillow

site:
	@echo Generating website ...
	. ./venv && python3 -m makesite
	@echo Done; echo
